    ...
    <header className="fixed top-0 w-full bg-black/95 text-white z-50 shadow-md">
      <nav className="relative max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          {/* Featured Button */}
          <Link
            href="/featured" className="text-white font-medium hover:text-gray-300 pl-4 absolute left-0">
            Featured
          </Link>
          <div className="hidden sm:flex items-center space-x-6 pl-24">
            <Link href="/men" className="text-gray-300 hover:text-white px-3 py-2 transition-all">
              Men
            </Link>
            <Link href="/products/lehenga" className="text-gray-300 hover:text-white px-3 py-2 transition-all">
              Women
            </Link>
          </div>
